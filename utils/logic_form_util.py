...
from configs.common_config import reverse_properties_file_path, fb_roles_file_path, fb_types_file_path
# from utils.config_grailqability import grailqa_reverse_properties_dict_path, grailqa_property_roles_dict_path,\
# grailqa_fb_types_path
...
reverse_properties = {}
with open(reverse_properties_file_path, 'r') as f:
    for line in f:
        reverse_properties[line.split('\t')[0]] = line.split('\t')[1].replace('\n', '')

with open(fb_roles_file_path, 'r') as f:
    content = f.readlines()
...
with open(fb_types_file_path, 'r') as f:
    content = f.readlines()
