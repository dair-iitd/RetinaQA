...
from configs.common_config import fb_roles_file_path, fb_types_file_path, reverse_properties_file_path
...
reverse_properties, relation_dr, relations, upper_types, types = process_ontology(fb_roles_file_path, fb_types_file_path,\
                                                                                         reverse_properties_file_path)
