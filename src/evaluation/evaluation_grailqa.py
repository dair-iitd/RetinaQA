...
def calc_em_f1(item, predict, matcher, level_count, level_em_sum, level_f1_sum, em_sum, pr_sum, re_sum, f1_sum):
    item['level']='iid'
...
def score_for_qids(dataset, qids, predict, matcher, level_count, level_em_sum, level_f1_sum):
    ...
    for item in dataset:
        ...
        level_count, level_em_sum, level_f1_sum, em_sum, pr_sum, re_sum, f1_r_sum = calc_em_f1(item, predict, matcher, level_count, level_em_sum, level_f1_sum, em_sum, pr_sum, re_sum, f1_r_sum)
                            
    stats = {}
    stats['F1'] = round(((f1_r_sum / max(1, qcount))*100), 2)
