...
class Data:
    def __init__(self, data_path, schema_path, entity_linking_path, sketch_path, lf_candidates_path, split="train", data_type="AU"):
        self.data = {}
        self.linked_schema = {}
    ...
    def get_gold_sketch_by_qid(self, qid):
        ...
        s_exp = self.data[str(qid)]["s_expression"]
    ...
    def get_linked_schema_by_qid(self, qid):
        return (self.linked_schema[str(qid)]["classes"], self.linked_schema[str(qid)]["relations"])
...
def get_all_sexps(sketches, rels, types, ents, logical_form_validator, gold_sexp=""):
    rels = list(set(rels))
    ...
    for qid_idx, qid in tqdm(enumerate(data_class.data)):
        ...
        if data_class.lf_candidates.get(str(qid), {}) != {}:
            ...
            valid_sexps, invalid_sexps, correct_sexps = get_all_sexps(sketches=predicted_sketches, rels=linked_schema_rels,\
                                                                        ...
                                                                        gold_sexp=gold_sexp, logical_form_validator=logical_form_validator)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_type', type=str, required=True) #A, AU
    ...
    if args.split=="train":
        ...
        data_class = Data(data_path=data_train_path, \
                                ...
                                split="train",data_type=args.data_type)
        ...
        data_class = Data(data_path=data_dev_path,\
                                ...
                                split="dev",data_type=args.data_type)
        ...
        data_class = Data(data_path=data_test_path, \
                                ...
                                split="test",data_type=args.data_type)
